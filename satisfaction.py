#/usr/bin/python3
import pygame, sys, random, sortingAlgorithms, copy
        ...
        for y in range(gridHeight):
            if grid[x][y] != lastGrid[x][y] or first:
                pygame.display.update(
                    pygame.draw.rect(screen, (grid[x][y]*256, grid[x][y]*256, grid[x][y]*256), (x*pixelSize+offsetX, y*pixelSize+offsetY, pixelSize, pixelSize)))
